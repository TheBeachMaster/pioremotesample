...
public:
	...
	boolean connect(const char* devce_id, const char* username, const char* password, const char* will_topic, uint8_t will_qos, boolean will_retain, const char* will_message);
	void disconnect();
	...
	boolean publish_progmem(const char* topic, const uint8_t* payload, boolean retained);
